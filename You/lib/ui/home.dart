...
class _AnimationDemoHomeState extends State<AnimationDemoHome> {
  ...
  Future<bool> _onWillPop() {
    ...
    final double appBarMidScrollOffset = statusBarHeight + appBarMaxHeight - kAppBarMidHeight;

    if (_scrollController.offset >= appBarMidScrollOffset) {
      _scrollController.animateTo(0.0, curve: kScrollCurve, duration: kScrollDuration);
  ...
  void _maybeScroll(double midScrollOffset, int pageIndex, double xOffset) {
    if (_scrollController.offset < midScrollOffset) {
      ...
      _scrollController.animateTo(midScrollOffset, curve: kScrollCurve, duration: kScrollDuration);
    } else {
        ...
        children: <Widget>[
          NotificationListener<ScrollNotification>(
            ...
            child: CustomScrollView(
              ...
              physics: SnappingScrollPhysics(midScrollOffset: appBarMidScrollOffset),
              slivers: <Widget>[
