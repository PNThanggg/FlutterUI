...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan() {
    AlanVoice.addButton("<Enter your key here>", buttonAlign: AlanVoice.BUTTON_ALIGN_RIGHT);
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          [
            AppBar(
              title: "AI Radio".text.xl4.bold.white.make().shimmer(primaryColor: Vx.purple300, secondaryColor: Colors.white),
