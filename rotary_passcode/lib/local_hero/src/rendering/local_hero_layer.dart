...
class RenderLocalHeroLeaderLayer extends RenderProxyBox {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final painter = controller.isAnimating
        ? (PaintingContext context, Offset offset) => context.pushOpacity(offset, 0, super.paint)
        : super.paint;
...
class RenderLocalHeroFollowerLayer extends RenderProxyBox {
  ...
  void performLayout() {
    ...
    final BoxConstraints childConstraints =
        requestedSize == null ? constraints : constraints.enforce(BoxConstraints.tight(requestedSize));
